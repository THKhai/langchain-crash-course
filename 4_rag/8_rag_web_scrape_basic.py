...
persistent_directory = os.path.join(db_dir, "chroma_db_apple_gemini")
...
# GoogleGenerativeAIEmbeddings turns text into numerical vectors that capture semantic meaning
